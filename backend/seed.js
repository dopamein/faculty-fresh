...
async function seedDatabase() {
  ...
  if ((await LeaveRequest.estimatedDocumentCount()) === 0) {
    await LeaveRequest.insertMany([
      ...
      },
      {
        ...
        status: "Under Review",
        type: "Conference",
        reason: "IEEE Information Assurance and Security 2 Conference attendance...",
  ...
  if ((await DashboardSummary.estimatedDocumentCount()) === 0) {
    await DashboardSummary.create({
      ...
      depts: [
        { name: "Network Implementation and Support II", count: 48, color: "#0ea5e9", pct: 70 },
        { name: "Information Assurance and Security 2", count: 62, color: "#8b5cf6", pct: 90 },
